...
<div class="wrapper">
	...
	<div class="wrap">
			...
			<div class="phone_wrap">
				<div class="phone_number">휴대폰 번호</div>
...
$(document).ready(function(){
    ...
    $(".join_button").click(function(){
        ...
        if(phone == ""){
            ...
            phoneCheck = true; //여기 오타가 있죠? phone 인데 phonee
        }
        /* 이메일 유효성 검사 */
        if(mail == ""){
       ...
       /* 불필요한 부분이라 주석처리 했습니다. (나중에 참고하시라고 냅둘께요)
       	console.log("값: : " + id + " 체크값 : " + idCheck);
        console.log("값: : " + id + " 체크값 : " + idckCheck);
        console.log("값: : " + pw + " 체크값 : " + pwCheck);
        console.log("값: : " + pw + " 체크값 : " + pwckCheck);
        console.log("값: : " + pw + " 체크값 : " + pwckcorCheck);
        console.log("값: : " + name + " 체크값 : " + nameCheck);
        console.log("값: : " + phone + " 체크값 : " + phoneCheck);
        console.log("값: : " + mail + " 체크값 : " + mailCheck);
        console.log("값: : " + addr + " 체크값 : " + addressCheck); */
