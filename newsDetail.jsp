...
<body>
	...
	<div id="subContents">
		<table class="boardView">
		    ...
		    <tr>
		        <th>작성자</th>
		        <td class="newsWriter">${news.WRITER}</td>
		        <th>작성일</th>
		        <td>${news.getREG_DT()}</td>
		    </tr>
		    <tr>
		        <th>내용</th>
		        <td colspan="3" class="substance">${news.CONTENT}</td>
		    </tr>
		</table>
		<div class="pageBtn">
		    <div class="btnWrap">
		        <a href="getNews.do" class="listBtn">목록</a>
		        <a href="getNewsUpdateForm.do?SEQ=${news.SEQ}" class="modifyBtn">수정</a>
		        <a href="deleteNews.do?SEQ=${news.SEQ}" class="deleteBtn">삭제</a>
		    </div>
		</div>
	</div>
